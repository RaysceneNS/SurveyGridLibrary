...
namespace UnitTestProject1
{
    ...
    public class DlsSectionMarkersTests
    {
        ...
        public void TestMethod1()
        {
            ...
            var markers = provider.BoundaryMarkers(1, 1, 1, 1);
        ...
        {
            var provider = DlsMarkerProvider.Instance;
            var markers = provider.BoundaryMarkers(6, 1, 30, 3);
        ...
        {
            var provider = DlsMarkerProvider.Instance;
            var markers = provider.BoundaryMarkers(127, 127, 127, 127);
        ...
        {
            var markers = DlsSystem.TownshipMarkers(23, 29, 4);
            // this township has only 85 markers as it is cut in half vertically..
